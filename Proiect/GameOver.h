...
void deseneaza_ecran_game_over(void) {
	...
	glBegin(GL_POLYGON);
	glVertex2i((0), (0));
	glVertex2i((0), (WINDOW_HEIGTH));
	glVertex2i((WINDOW_WIDTH), (WINDOW_HEIGTH));
	glVertex2i((WINDOW_WIDTH), (0));
	glEnd();

	// Chenar
	double left_x = (WINDOW_WIDTH / 4);
	double left_y = (WINDOW_HEIGTH / 4);
	double right_x = (3 * WINDOW_WIDTH / 4);
	double right_y = (3 * WINDOW_HEIGTH / 4);
	glColor3f(1, 1, 1);
	glBegin(GL_POLYGON);
